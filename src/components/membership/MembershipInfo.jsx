...
export default function MembershipInfo({ info }) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 p-6">
      ...
      <InfoRow icon="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" label="Membership Name">
        {info.membershipName}
      </InfoRow>

      <InfoRow icon="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" label="Membership Tier">
      ...
      <InfoRow icon="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" label="Start Date">
      ...
      <InfoRow icon="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" label="Annual Commitment">
        {formatCurrency(info.annualCommitment)}
      </InfoRow>

      <InfoRow icon="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z" label="Membership Notes">
        <span className="text-gray-500 leading-relaxed">{info.notes}</span>
      </InfoRow>
    </div>
  );
}
