export default function TopBar({
  ...
  notificationCount = 3,
  title = "Member Portal",
  breadcrumbs = [],   // e.g. [{label:"Dashboard",href:"#"},{label:"Membership",href:"#"},{label:"Membership Details"}]
}) {
        ...
        <div className="flex items-center gap-1.5 pb-2.5 -mt-1">
          {breadcrumbs.map((crumb, i) => (
            <span key={i} className="flex items-center gap-1.5">
              ...
              {crumb.href ? (
                <a href={crumb.href} className="text-[12px] text-gray-400 hover:text-[#1a6bdc] transition-colors">
                  {crumb.label}
                </a>
              ) : (
