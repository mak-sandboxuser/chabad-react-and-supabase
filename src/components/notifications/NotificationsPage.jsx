...
import NotificationsList, { notificationsData } from "./NotificationsList";
...
export default function NotificationsPage() {
  ...
  return (
    <div className="flex h-screen bg-[#f4f6fb] overflow-hidden">
      {/* ✅ Reused — NavLink auto-highlights /notifications */}
      <Sidebar />

      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        {/* ✅ Reused TopBar */}
        <TopBar userName="John Doe" notificationCount={unreadCount} title="Notification Center" />
