  ...
  return (
    <div className="grid grid-cols-2 gap-5">
      ...
      <SupportCard
        ...
        primaryHref="mailto:info@chabadbedford.org"
        primaryFilled={true}
      />
      ...
      <SupportCard
        ...
        primaryHref="mailto:support@chabadbedford.org"
        primaryExternal={true}
        primaryFilled={false}
        extraLines={[
          { text: "support@chabadbedford.org", href: "mailto:support@chabadbedford.org", style: "text-[#1a6bdc] hover:underline" },
        ]}
      />
      ...
      <SupportCard
        ...
        primaryHref="tel:+11234567890"
        primaryFilled={false}
        extraLines={[
          { text: "(123) 456-7890", href: "tel:+11234567890", style: "text-[#1a6bdc] font-semibold hover:underline" },
          { text: "Mon – Fri, 9:00 AM – 5:00 PM EST", style: "text-gray-400" },
        ]}
      />
    </div>
  );
